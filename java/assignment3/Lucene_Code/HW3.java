...
public class HW3 {
    ...
    queries[0] = "global warming potential";
    queries[1] = "green power renewable energy";
    queries[2] = "solar energy california";
    queries[3] = "light bulb bulbs alternative alternatives";
